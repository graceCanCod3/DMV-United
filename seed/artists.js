...
const main = async () => {
    const dcArtists = await LocalArtist.find({musicStyle: "go-go"})
    const localArtist = await LocalArtist.find({ location: "Washington, DC"})
    ...
    const artists = [
        {
          ...
          genre: "go-go",
          image: "https://i.imgur.com/mVye3o4.jpg",
          url: "https://www.instagram.com/mambosauceband/?hl=en",
        },
        {
          name: "Chuck Brown",
